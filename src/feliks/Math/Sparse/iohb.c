...
// modified by iris, before 1, now 0: even though IRIS works with 0 based
// vectors and matrices, the standard Matrix Market matrices have 1-based
// numbering, and thus we follow this convention
#ifndef _SP_base
#define _SP_base 0
#endif
/*---------------------------------------------------------------------*/
...
/*  First line:   */
    ...
    //by iro*(Key+8) = (char) NULL;
    *(Key+8) = '\0';
    //by iro *(Title+72) = (char) NULL;
    *(Title+72) = '\0';
