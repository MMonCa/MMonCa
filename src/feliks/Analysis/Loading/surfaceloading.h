...
#ifndef _surfaceloading_h
#define _surfaceloading_h
...
class surfaceLoading : public loading
{
	
public:
                    surfaceLoading(const commandLine& uc);
	virtual         ~surfaceLoading(){}
