...
test tag=Fe.balance array={ [extract balance name=A.atoms material=Iron file=Fe.bal] } value=0 init=2 end=19 error=0
test tag=Cr.balance array={ [extract balance name=B.atoms material=Iron file=Cr.bal] } value=0 init=2 end=19 error=0
