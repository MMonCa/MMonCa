...
test tag=Icon.noSat array="[extract profile.mobile name=I material=Silicon]"  value=$Icon init=2 end=18 error=0.05
...
test tag=Icon.sat array="[extract profile.mobile name=I]" value=$I_10 init=2 end=18  error=0.05
